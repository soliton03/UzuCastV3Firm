...
echo.
echo [TDM-I2S-TEST Master] ESP32-S3 on %UPLOAD_PORT%
echo [TDM-I2S-TEST Master] TDM 8ch TX path test
echo [TDM-I2S-TEST Master] Project: master, env=%PIO_ENV%
echo [TDM-I2S-TEST Master] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo TDM-I2S-TEST - writemaster.bat
echo   Build and upload Master test firmware (ESP32-S3 TDM TX).
echo.
echo Usage:

...
echo.
echo [TDM-I2S-TEST Slave] ESP32 on %UPLOAD_PORT%
echo [TDM-I2S-TEST Slave] I2S RX dump test
echo [TDM-I2S-TEST Slave] Project: slave, env=%PIO_ENV%
echo [TDM-I2S-TEST Slave] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo TDM-I2S-TEST - writeslave.bat
echo   Build and upload Slave test firmware (I2S RX dump).
echo.
echo Usage:

...
echo.
echo [uzcTest_i2s_bt Master] ESP32 on %UPLOAD_PORT%
echo [uzcTest_i2s_bt Master] MP3TEST2 SD_I2S -^> I2S TX
echo [uzcTest_i2s_bt Master] Project: master, env=%PIO_ENV%
echo [uzcTest_i2s_bt Master] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo uzcTest_i2s_bt - writemaster.bat
echo   Build and upload Master firmware (SD_I2S from MP3TEST2).
echo.
echo Usage:

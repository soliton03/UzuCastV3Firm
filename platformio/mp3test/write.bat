...
echo.
echo [mp3test] ESP32 on %UPLOAD_PORT%
echo [mp3test] Embedded MP3/RAW -^> I2S TX -^> Speaker
echo [mp3test] env=%PIO_ENV%  upload=%UPLOAD_SPEED% bps
echo.
...
:speed_without_s
echo [ERROR] Baud rate requires /s: write.bat COM10 /s %UPLOAD_PORT%
goto show_help_error
...
:show_help
echo.
echo mp3test - write.bat
echo   Build and upload standalone MP3/RAW playback test firmware.
echo.
echo Usage:

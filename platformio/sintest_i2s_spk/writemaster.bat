...
echo.
echo [sintest_i2s_spk Master] ESP32 on %UPLOAD_PORT%
echo [sintest_i2s_spk Master] Stage 1: I2S TX -^> Slave
echo [sintest_i2s_spk Master] Project: master, env=%PIO_ENV%
echo [sintest_i2s_spk Master] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo sintest_i2s_spk - writemaster.bat
echo   Build and upload Stage-1 Master firmware (ESP32 I2S TX).
echo.
echo Usage:

...
echo.
echo [sintest_i2s_spk Slave] ESP32 on %UPLOAD_PORT%
echo [sintest_i2s_spk Slave] Stage 1: I2S RX -^> I2S TX -^> Speaker
echo [sintest_i2s_spk Slave] Project: slave, env=%PIO_ENV%
echo [sintest_i2s_spk Slave] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo sintest_i2s_spk - writeslave.bat
echo   Build and upload Stage-1 Slave firmware (ESP32 I2S RX/TX).
echo.
echo Usage:

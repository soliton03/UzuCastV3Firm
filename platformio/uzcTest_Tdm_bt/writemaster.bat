...
echo.
echo [uzcTest_Tdm_bt Master] ESP32-S3 on %UPLOAD_PORT%
echo [uzcTest_Tdm_bt Master] SD_MMC + TDM 8ch TX
echo [uzcTest_Tdm_bt Master] Project: master, env=%PIO_ENV%
echo [uzcTest_Tdm_bt Master] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:speed_without_s
echo [ERROR] Baud rate requires /s: writemaster.bat COM5 /s %UPLOAD_PORT%
goto show_help_error
...
:show_help
echo.
echo uzcTest_Tdm_bt - writemaster.bat
echo   Build and upload Master firmware (ESP32-S3 TDM TX).
echo.
echo Usage:

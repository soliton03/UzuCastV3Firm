...
echo.
echo [uzcTest_i2s_bt Slave] ESP32 on %UPLOAD_PORT%
echo [uzcTest_i2s_bt Slave] uzuCastSubMP3 I2S RX -^> BT A2DP
echo [uzcTest_i2s_bt Slave] Project: slave, env=%PIO_ENV%
echo [uzcTest_i2s_bt Slave] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:speed_without_s
echo [ERROR] Baud rate requires /s: writeslave.bat COM4 /s %UPLOAD_PORT%
goto show_help_error
...
:show_help
echo.
echo uzcTest_i2s_bt - writeslave.bat
echo   Build and upload Slave firmware (uzuCastSubMP3 / BT A2DP).
echo.
echo Usage:

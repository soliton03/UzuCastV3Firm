...
echo.
echo [sintest_i2s_bt Master] ESP32 on %UPLOAD_PORT%
echo [sintest_i2s_bt Master] Stage 2: I2S TX -^> Slave -^> BT
echo [sintest_i2s_bt Master] Project: master, env=%PIO_ENV%
echo [sintest_i2s_bt Master] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo sintest_i2s_bt - writemaster.bat
echo   Build and upload Stage-2 Master firmware (ESP32 I2S TX).
echo.
echo Usage:

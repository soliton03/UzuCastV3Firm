...
echo.
echo [sintest_i2s_mp3 Slave] ESP32 on %UPLOAD_PORT%
echo [sintest_i2s_mp3 Slave] Stage 2: I2S RX RAW/MP3 -^> Bluetooth A2DP
echo [sintest_i2s_mp3 Slave] Project: slave, env=%PIO_ENV%
echo [sintest_i2s_mp3 Slave] Upload baud: %UPLOAD_SPEED% bps
echo.
...
:show_help
echo.
echo sintest_i2s_mp3 - writeslave.bat
